class MultiBaseInput < SimpleForm::Inputs::CollectionInput
  ...
  def input(wrapper_options)
    ...
    @requested_user_id = input_html_options[:current_user_id] # Useful for owner prepopulating and lookup permissions.
    @default_val = input_html_options[:default_val] # New way of setting a default
