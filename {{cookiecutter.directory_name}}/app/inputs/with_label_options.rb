module WithLabelOptions
  ...
  def add_checkbox
    ...
    if input_html_options[:checkbox_disable]
      return <<-HTML
    ...
    <div style="float:right;">
       <div class="input boolean optional #{input_dom_id}_checkbox_div">
        <input data-js-toggle-disable-form-field="true" data-field-name="#{input_html_options[:checkbox_disable]}" class="boolean optional" type="checkbox" value="true" name="#{object_name}[#{attribute_name}_checkbox]" id="#{object_name}_#{attribute_name}_checkbox" #{checkbox_checked}>
